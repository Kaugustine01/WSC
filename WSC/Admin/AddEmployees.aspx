...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content">
        ...
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
            ...
            <asp:RequiredFieldValidator ID="RequiredFiledValidator10" runat="server"
                ControlToValidate="txtEmpType" ErrorMessage="Employee Type Required." ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
