    ...
    <div class="content">
        <center>
            <asp:Login ID="Login1" runat="server" OnAuthenticate="OnAuthenticate" BackColor="#F7F7DE" BorderColor="#CCCC99"
                BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="10pt" UserName="" PasswordRecoveryText="Forgot Password" PasswordRecoveryUrl="~/PasswordRecovery.aspx">
